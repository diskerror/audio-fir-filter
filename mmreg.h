 ...
 *
 *	Modified to use boost/endian.hpp
 *
 */
...
// As for the layout of other RIFF WAVE chunks such as 'cue ', 'smpl', 'plst', 'wavl', etc...
// Windows headers do not document these.
// See these documents about the original RIFF spec from 1991 for info:
